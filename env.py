...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        # Obstacle 2
        self.obstacle2 = self.canvas_widget.create_image(pixels * 2, 0, anchor='nw', image=self.obstacle6_object)
        # Obstacle 3
        ...
        # Obstacle 6
        self.obstacle6 = self.canvas_widget.create_image(pixels, pixels, anchor='nw', image=self.obstacle7_object)
        # Obstacle 7
        ...
        # Obstacle 14
        self.obstacle14 = self.canvas_widget.create_image(pixels * 3, pixels * 6, anchor='nw', image=self.obstacle8_object)
        # Obstacle 15
        self.obstacle15 = self.canvas_widget.create_image(pixels * 2, pixels * 5, anchor='nw', image=self.obstacle1_object)
        # Obstacle 16
        self.obstacle16 = self.canvas_widget.create_image(pixels * 8, 0, anchor='nw', image=self.obstacle3_object)
        # Obstacle 17
        self.obstacle17 = self.canvas_widget.create_image(pixels * 5, pixels * 3, anchor='nw', image=self.obstacle4_object)
        # Obstacle 18
        ...
        # Obstacle 20
        self.obstacle20 = self.canvas_widget.create_image(pixels * 5, pixels * 8, anchor='nw', image=self.obstacle4_object)
        # Obstacle 21
        self.obstacle21 = self.canvas_widget.create_image(pixels * 6, 0, anchor='nw', image=self.obstacle4_object)
        # Obstacle 22
        self.obstacle22 = self.canvas_widget.create_image(pixels * 2, pixels * 8, anchor='nw', image=self.obstacle2_object)
    ...
    def reset(self):
        ...
        self.agent = self.canvas_widget.create_image(pixels * 4, 0, anchor='nw', image=self.robot)
